...
def bookingScraper(hotel_data):
    ...
    try:
        price = driver.find_elements(By.XPATH, '//*[@id="app-layer-base"]/div/main/div/div/div/div/div/div[2]/section[2]/div/div[2]/div/div[2]/div[1]/div[2]/div[3]/div/div/div[2]/div/div[2]/div[2]/div/div/div[1]/div/div')
...
with open("C:/Users/mnuri/Desktop/moledro/scrapping/json/jsonHotel1.json", "r") as my_file:
